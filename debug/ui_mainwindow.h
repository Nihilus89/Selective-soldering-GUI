...
public:
    ...
    QLabel *fiducialLabel;
    QPushButton *locateFiducialButton;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        startMotorsButton->setGeometry(QRect(1010, 110, 111, 27));
        ...
        cameraImage->setGeometry(QRect(10, 0, 500, 281));
...
"border-color: #262626;"));
        ...
        fiducialLabel = new QLabel(centralWidget);
        fiducialLabel->setObjectName(QStringLiteral("fiducialLabel"));
        fiducialLabel->setGeometry(QRect(10, 290, 501, 131));
        fiducialLabel->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        locateFiducialButton = new QPushButton(centralWidget);
        locateFiducialButton->setObjectName(QStringLiteral("locateFiducialButton"));
        locateFiducialButton->setGeometry(QRect(1010, 80, 113, 32));
        startButton = new QPushButton(centralWidget);
        startButton->setObjectName(QStringLiteral("startButton"));
        startButton->setGeometry(QRect(1010, 140, 113, 32));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Selective soldering", 0));
        ...
        fiducialLabel->setText(QString());
        locateFiducialButton->setText(QApplication::translate("MainWindow", "Locate fiducial", 0));
